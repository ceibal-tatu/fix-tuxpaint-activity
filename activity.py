...
class TuxPaintLauncher(Activity):
    ...
    def run(self):
        if self.ready == True:
            ...
            os.system ('tuxpaint --nolockfile --native --fullscreen 1 --noprint --savedir ' + self.savedir + ' --in-file ' + self.file_tmp + ' &')
        else:
            logger.info ("Starting ...")
            os.system ('tuxpaint --nolockfile --native --fullscreen 1 --noprint --savedir ' + self.savedir + ' &')
